...
namespace MyProject.Controllers
{
    ...
    public class RecipesController : Controller
    {
        ...
        [AllowAnonymous]
        public ActionResult ContentToPDF(int id, string name)
        {
           return new ActionAsPdf("Details2", new { id = id }){ FileName = name+".pdf" };           
        }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.RecipeLikes.RemoveRange(db.RecipeLikes.Where(r => r.RecipeID == recipe.ID));
            db.SaveChanges();
            return RedirectToAction("Index");
        }
